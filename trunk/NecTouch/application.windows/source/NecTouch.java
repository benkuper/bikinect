...
public class NecTouch extends PApplet {
...
public void setup()
{
  ...
  autoCalibrate = PApplet.parseBoolean(xmlStartup.getString("autoCalibrate","false"));
  ...
  nonLinearMode = PApplet.parseBoolean(xmlDetection.getString("nonLinear"));
  ...
  swapXY =  PApplet.parseBoolean(xmlDetection.getString("swapXY", "false"));
...
public float calculateNonLinearCoord(PVector va, PVector va2, PVector vb, PVector vb2, PVector ve)
{
...
public PVector pixelIndexToVector(int pixelIndex,int w, int h)
{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "NecTouch" });
  }
}
